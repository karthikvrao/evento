        ...
        <div className="w-full max-w-[440px] animate-in slide-in-from-right-8 duration-1000">
          ...
          <div className="bg-card/40 backdrop-blur-2xl p-8 lg:p-10 rounded-3xl border border-border/50 shadow-2xl shadow-black/20">
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground mt-2">Get started for free today</p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-[10px] uppercase font-bold tracking-[0.2em]">
                  <span className="bg-background px-4 text-muted-foreground rounded-full border border-border/20 py-0.5">Or email</span>
                </div>
              </div>
              ...
              <form onSubmit={handleSignUp} className="space-y-5">
                ...
                <div className="space-y-2">
                  <Label htmlFor="password" title="Create a strong password" className="text-sm font-semibold ml-1">Password</Label>
                  <div className="relative">
                    <Input 
                      id="password" 
              ...
              */}
              ...
              <div className="text-center text-base pt-4">
                ...
                <Link to="/signin" className="text-primary font-bold hover:underline underline-offset-4 decoration-2">
                  Sign in
                </Link>
              </div>
            </div>
